          ...
          <div class="container-sections-seven">
            ...
            <div class="row">
              <div class="col-md-12">
               ...
               <h1>Problemas Cardiovasculares</h1>
               ...
               <ul>
                 ...
                 <li style="color:#fff;"> Problemas Cardiovasculares</li>
               </ul>
          ...
          <div class="container-sections-eight">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <p>
                  En este caso regenera el endotelio de los vasos sanguíneos y de las cavidades cardiovasculares. Cuando los inductores de regeneración celular ingresan a la circulación ocurre varios sucesos como el tropismo, la integración, la transdiferenciación, el reclutamiento de células madre endógenas, la reparación, la regeneración y la división celular asimétrica; presentes antes, durante y después de la reparación y regeneración del sitio afectado.
                 </p>
              </div>

              <div class="col-md-6">
                <img src="./images/img/problemas-2.jpg">
              </div>
