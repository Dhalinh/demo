          ...
          <div class="container-sections-eight">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <h2>Visión</h2>
                <p>
                  Los inductores de regeneración celular tienen influencia en los conos y bastones mejorando la agudeza visual. En el caso de la mácula, revierten la degeneración de la misma, evitando el deterioro y daño progresivo.
                  <br><br>
                  La visión se ve afectada por enfermedades crónico-degenerativas como la diabetes. Pacientes sometidos a la terapia de CORCE Inductores han mostrado mejoras notorias en su visión.
                 </p>
              </div>

              <div class="col-md-6">
                <img src="./images/img/cancer-2.jpg">
              </div>
